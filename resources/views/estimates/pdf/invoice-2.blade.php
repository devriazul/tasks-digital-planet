    ...
    <div class="invoice-body">
        ...
        <section id="sums">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="amount-total">
                    ...
                    <td>
                        <hr>{{ number_format((float)$estimate->total, 2, '.', '') }} {!! htmlentities($estimate->currency->currency_code)  !!}
                    </td>
                </tr>
            </table>
        ...
        <section id="terms">
            @if(!is_null($estimate->note))
                <p class="mb-1">@lang('app.note'):</p>
                <div>{!! nl2br($estimate->note) !!}</div>
            @endif
            <p class="mb-1">@lang('modules.invoiceSettings.invoiceTerms'):</p>
